...
\begin{wrapfigure}[10]{r}{8cm}
	\includegraphics[draft=false,scale=0.5]{Illustrationen/3-Einleitung/nemacaps_1.jpg}
	\caption{NemaCaps}
	\label{fig:nemacaps}
\end{wrapfigure}
...
\begin{wrapfigure}[14]{r}{8cm}
	\includegraphics[draft=false,scale=0.5]{Illustrationen/3-Einleitung/zyklus_nematoden.png}
