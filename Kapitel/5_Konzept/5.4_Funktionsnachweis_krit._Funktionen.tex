...
\end{itemize} 
\newpage
Dieses Konzept wird von der Firma Kofatec GmbH für die Vereinzelung von Pfefferkörner eingesetzt. Dabei ist das Design des Funktionsnachweises stark am Funktionsmuster der Firma Kofatec GmbH angelehnt. Das Funktionsmuster wird mittels Lasermaschine aus MDF hergestellt. Zudem wird die Lochmaske für einen ersten Funktionsnachweis von Hand betrieben (Siehe Abbildung \ref{fig:funktmuster_vereinzelung}).
\begin{figure}[H]
