...
\textit{(ygu)} Bei der Definition der Kriterien ist darauf zu achten, dass jedes Kriterium Relevanz für die Aufgabenstellung hat. Als Orientierung wurde die 'Leitlinie mit Hauptmerkmalen zum Bewerten in der Konzeptionsphase' (\textbf{korrekte Deklaration?}) verwendet \cite{pahl}. 
\newline
