...
Für die Bewertung der Konzepte wird eine Nutzwertanalyse nach Naefe (2003) durchgeführt. Angepasst auf diese Bachelorarbeit ergiebt sich folgendes Vorgehen:
...
\begin{enumerate}
	...
	\item \textbf{Beurteilen nach Wertvorstellung:} Mit der definierten Wertskala nach VDI-Richtlinie 2225 werden die einzelnen Konzepte an den definierten Kriterien bewertet.
...
Bei der Definition der Kriterien ist darauf zu achten, dass jedes Kriterium Relevanz für die Aufgabenstellung hat. Als Orientierung wurde die "Leitlinie mit Hauptmerkmalen zum Bewerten in der Konzeptionsphase" nach Pahl und Beitz (2003) verwendet. 
\newline
