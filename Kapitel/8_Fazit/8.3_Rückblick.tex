...
\textit{(pro)} Dieses Unterkapitel bietet eine Übersicht über die getätigten Ausgaben. Die genaue Auflistung aller Positionen sämtlicher Bestellungen findet sich im Anhang. Nach folgendem Schema wurde bei einer grösseren Materialbestellung vorgegangen:
