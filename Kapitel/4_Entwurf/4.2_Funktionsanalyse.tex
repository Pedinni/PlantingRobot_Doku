...
\begin{figure}[H]
	\includegraphics[draft=false,width=1\textwidth]{Illustrationen/4-Entwurf/Funktionsanalyse_Pflicht.png}
...
\begin{itemize}
	...
	\begin{figure}[H]
		\includegraphics[draft=false,width=1\textwidth]{Illustrationen/4-Entwurf/Funktionsanalyse_Wunsch.png}
